                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return InkWell(
                                      onTap: () {
                                        ...
                                        Navigator.push(
                                            context, MaterialPageRoute(builder: (context) => SelectVehicle()));
                                      },
                                      onLongPress: () async {
                                        ...
                                        if (deleteConfirmed ?? false) {
                                          provider.deleteDropLocation(provider.dropHistoryData!.list[index]
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 10),
              SizedBox(width: MediaQuery.of(context).size.width * 0.7, child: Text(address)),
            ],
          ),
