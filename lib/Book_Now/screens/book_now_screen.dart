...
class _BookNowScreenState extends State<BookNowScreen> {
  ...
  LatLng _currentLocation =
      LatLng(30.365518638199323, 78.04342051246367); // Example coordinates
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  child: rideOption(
                                      'Car', 'assets/images/typecar3.png')),
                            ],
                          ),
                        ),
                      ],
          ...
          Container(
            ...
            child: Center(
              child: Image.asset(assetPath,
                  width: 60, height: 60), // Use SVG or image asset
            ),
          ),
          SizedBox(height: 5),
          Text(name, style: TextStyle(fontSize: 15, fontFamily: "Poppins")),
        ],
      ),
    );
  }
