...
class _SelectPickupTimeState extends State<SelectPickupTime> {
  ...
  static const LatLng _startLocation =
      LatLng(30.365368, 78.044571); // San Francisco
    ...
    setState(() {
      ...
      for (DateTime date in upcomingDates) {
        List<String> timeSlots = List.generate(5, (index) {
          ...
          String timeLabel =
              DateFormat('h:mm a').format(DateTime(0, 0, 0, hour, 0));
          return timeLabel;
        });
                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                  _selectedDate = date;
                                  _selectedTime =
                                      null; // Reset time selection when changing date
                                });
                              },
                              child: Container(
                                width: 80,
                      ...
                      _selectedDate != null
                          ? Container(
                              ...
                              child: ListView.builder(
                                scrollDirection: Axis.horizontal,
                                itemCount:
                                    _availableTimes[_selectedDate]!.length,
                                itemBuilder: (context, index) {
                                  String time =
                                      _availableTimes[_selectedDate]![index];
