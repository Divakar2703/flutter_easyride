            ...
            child: SingleChildScrollView(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 10,),
                      IconButton(
                        icon: Icon(Icons.info_outline, color: Color(0xff1937d7)),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Confirm Booking', style: TextStyle(fontSize: 14,fontFamily:"Poppins",color: Colors.white,fontWeight: FontWeight.w400)),
                ),
              ),
                        ),
                ],
