...
import '../../Pre_Booking/screens/confirm_booking_screen.dart';
import '../../common_widget/map_widget.dart';
import '../../provider/map_provider.dart';

class RentalBookingDetailsView extends StatefulWidget {
  @override
  _RentalBookingDetailsViewState createState() => _RentalBookingDetailsViewState();
}

class _RentalBookingDetailsViewState extends State<RentalBookingDetailsView> {
  ...
  TextEditingController _promoController = TextEditingController(); // Controller for promo code input
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text("Fare Breakdown", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
              SizedBox(height: 10),
              ...
              child: Column(
                ...
                children: [
                  Card(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset(
                            'assets/images/ride_car_two.png',
                            height: 70,
                            width: 120,
                          ),
                          SizedBox(width: 10,),
                              ...
                              Text(
                               "Blue Classic",
                                style: TextStyle(
                                  ...
                                  color: Color(0xff1937d7), // Change here
                                  fontFamily: 'Poppins',
                                ),
                              ),
                              Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: Colors.black87, // Change here
                                      fontFamily: 'Poppins',
                                    ),
                                  ),
                                  Text(
                  ...
                  Row(
                    ...
                    children: [
                      _buildBox("Date & Time", Icons.arrow_drop_down, _onDateTap,"$selectedDate, $selectedTime"),
                      _buildBox("Wallet", Icons.arrow_drop_down, _onWalletTap,"$_selectedPaymentMethod"),

                    ],
                  ),
                  Row(children: [
                    _buildBox("Add Notes", Icons.arrow_drop_down, _onAddNotesTap,""),
                    _buildBox("Promo Code", Icons.arrow_drop_down, _onPromoTap,"$promoCode"),
                  ],),
                  SizedBox(height: 20),
                  Padding(
  ...
  Widget _buildBox(String label, IconData icon, VoidCallback onTap,String value) {
  ...
  Widget _buildDateTimePicker(BuildContext context) {
    ...
    List<String> timeOptions = List.generate(24, (index) => '${index.toString().padLeft(2, '0')}:00');
              ...
              children: [
                ...
                Expanded(
                  child: CupertinoPicker(
                    itemExtent: 40,
                    scrollController: FixedExtentScrollController(initialItem: selectedDateIndex),
                ...
                Expanded(
                  child: CupertinoPicker(
                    itemExtent: 40,
                    scrollController: FixedExtentScrollController(initialItem: selectedTimeIndex),
                    onSelectedItemChanged: (int index) {
      ...
      builder: (context) {
        return Padding(
          padding: EdgeInsets.only(
            bottom: MediaQuery.of(context).viewInsets.bottom, // To prevent keyboard overlap
          ),
          child: Container(
            color: Colors.white,
            padding: EdgeInsets.all(16),
                                          ...
                                          child: Radio(
                                            ...
                                            onChanged: (int? value) {
                                              setState(() {
                                                ...
                                                selectedInstruction="Contactless delivery at the door";
                                        ...
                                        Transform.scale(
                                          ...
                                          child: Radio(
                                            ...
                                            onChanged: (int? value) {
                                              setState(() {
                                                selectedSwitch = value!;
                                                selectedInstruction="Contactless delivery to the guard";
                                              });
                                            },
                                            activeColor: Color(0xff29b2fe),
                                          ),
                                        ...
                                        Transform.scale(
                                          ...
                                          child: Radio(
                                            ...
                                            onChanged: (int? value) {
                                              setState(() {
                                                selectedSwitch = value!;
                                                selectedInstruction="Hand me the order";
                                      ...
                                      children: [
                                        Checkbox(
                                          ...
                                          onChanged: (value) {
                                            setState(() {
                                              isChecked = value!;
                                              selectedAInstruction="Don't ring the bell";
                                            });
                                          },
                                          activeColor: Color(0xff29b2fe),
                                        ),
  ...
  String _selectedPaymentMethod = 'Cash on Delivery'; // Initial payment option selected
        ...
        return DraggableScrollableSheet(
          ...
          builder: (BuildContext context, ScrollController scrollController) {
            return Container(
              color: Colors.white,
              child: SingleChildScrollView(
                controller: scrollController, // Makes the bottom sheet scrollable
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: RadioListTile(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 16),
            Text(title, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400,fontFamily: "Poppins",color: Color(0xff1937d7))),
          ],
        ),
        subtitle: Text(subtitle,style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400,fontFamily: "Poppins",color: Colors.grey),),
      ),
    );
  }
